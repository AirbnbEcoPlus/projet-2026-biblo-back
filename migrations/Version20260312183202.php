 ...
 */
final class Version20260312183202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, date_sortie DATE NOT NULL, langue VARCHAR(255) DEFAULT NULL, photo_couverture VARCHAR(255) DEFAULT NULL, reservation_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_AC634F99B83297E7 (reservation_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, date_resa DATE NOT NULL, adherent_id INT DEFAULT NULL, INDEX IDX_42C8495525F06C53 (adherent_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
