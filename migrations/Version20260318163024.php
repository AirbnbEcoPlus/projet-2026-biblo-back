 ...
 */
final class Version20260318163024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, date_resa DATE NOT NULL, livre_id INT DEFAULT NULL, adherent_id INT NOT NULL, UNIQUE INDEX UNIQ_42C8495537D925CB (livre_id), INDEX IDX_42C8495525F06C53 (adherent_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
